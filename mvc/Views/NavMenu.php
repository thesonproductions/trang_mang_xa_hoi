<?php 
include_once "NavMenuLeft.php";
include "mvc/Controllers/NavController.php";
$user = new Nav();
                                ...
                                <div class="card-body p-0">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded"
                                                     src="galleys/public/assets/images/user/01.jpg" alt="">
                                                <div class="ms-3">
                                    ...
                                    <div class="iq-friend-request">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded"
                                                     src="galleys/public/assets/images/user/02.jpg" alt="">
                                                <div class="ms-3">
                                    ...
                                    <div class="iq-friend-request">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded"
                                                     src="galleys/public/assets/images/user/03.jpg" alt="">
                                                <div class=" ms-3">
                                    ...
                                    <div class="iq-friend-request">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="avatar-40 rounded"
                                                     src="galleys/public/assets/images/user/04.jpg" alt="">
                                                <div class="ms-3">
                                ...
                                <div class="card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                     src="galleys/public/assets/images/user/05.jpg" alt="">
                                            </div>
                                            <div class="ms-3">
                            ...
                            <div class="card shadow-none m-0">
                                ...
                                <div class="card-body p-0 ">
                                    ...
                                    <div class="d-inline-block w-100 text-center p-3">
                                        <a class="btn btn-primary iq-sign-btn" href="sign-in.html"
                                           role="button">Sign
...
<?php include_once "NavMenuRight.php"; ?>