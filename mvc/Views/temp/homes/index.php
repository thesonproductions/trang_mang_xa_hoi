<div id="content-page" class="content-page">
    <div class="container" style="max-width: 1124px;">
        <div class="row">
                    ...
                    <div id="post-modal-data" class="card card-block card-stretch card-height">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="user-img">
                                    <img src="galleys/public/assets/images/user/1.jpg" alt="userimg"
                            ...
                            <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                                <li class="me-3 mb-md-0 mb-2">
                                    <a href="#" class="btn btn-soft-primary">
                                        <img src="galleys/public/assets/images/small/07.png" alt="icon"
                                ...
                                <li class="me-3 mb-md-0 mb-2">
                                    <a href="#" class="btn btn-soft-primary">
                                        <img src="galleys/public/assets/images/small/08.png" alt="icon"
                                             class="img-fluid me-2">
                                        Tag Friend
                                    </a>
                                </li>
                                <li class="me-3">
                                    <a href="#" class="btn btn-soft-primary">
                                        <img src="galleys/public/assets/images/small/09.png" alt="icon"
                                             class="img-fluid me-2">
                                        Feeling/Activity
                                    </a>
                                </li>
                                        ...
                                        <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/07.png"
                                                                          alt="icon" class="img-fluid"> Photo/Video
                                                </div>
                                            </li>
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/08.png"
                                                                          alt="icon" class="img-fluid"> Tag Friend
                                                </div>
                                            </li>
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/09.png"
                                            ...
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/10.png"
                                                                          alt="icon" class="img-fluid"> Check in
                                                </div>
                                            </li>
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/11.png"
                                                                          alt="icon" class="img-fluid"> Live Video
                                                </div>
                                            </li>
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/12.png"
                                                                          alt="icon" class="img-fluid"> Gif
                                                </div>
                                            </li>
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/13.png"
                                                                          alt="icon" class="img-fluid"> Watch Party
                                                </div>
                                            </li>
                                            <li class="col-md-6 mb-3">
                                                <div class="bg-soft-primary rounded p-2 pointer me-3"><a
                                                        href="#"></a><img src="galleys/public/assets/images/small/14.png"
                        ...
                        <div class="card-body">
                            <div class="user-post-data">
                                <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                        <img class="rounded-circle img-fluid" src="galleys/public/assets/images/user/01.jpg"
                                             alt="">
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                            ...
                            <div class="user-post">
                                <div class=" d-grid grid-rows-2 grid-flow-col gap-3">
                                    <div class="row-span-2 row-span-md-1">
                                        <img src="galleys/public/assets/images/page-img/p2.jpg" alt="post-image"
                                             class="img-fluid rounded w-100">
                                    </div>
                                    <div class="row-span-1">
                                        <img src="galleys/public/assets/images/page-img/p1.jpg" alt="post-image"
                                             class="img-fluid rounded w-100">
                                    </div>
                                    <div class="row-span-1 ">
                                        <img src="galleys/public/assets/images/page-img/p3.jpg" alt="post-image"
                                             class="img-fluid rounded w-100">
                                    </div>
                                </div>
                            </div>
                            <div class="comment-area mt-3">
                                            ...
                                            <div class="like-data">
                                                <div class="dropdown">
                                                            <span class="dropdown-toggle" data-bs-toggle="dropdown"
                                                                  aria-haspopup="true" aria-expanded="false"
                                                                  role="button">
                                                                <img src="galleys/public/assets/images/icon/01.png"
                                                                     class="img-fluid" alt="">
                                                            </span>
                                                    <div class="dropdown-menu py-2">
                                                        <a class="ms-2 me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="Like"><img
                                                                src="galleys/public/assets/images/icon/01.png"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="Love"><img
                                                                src="galleys/public/assets/images/icon/02.png"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="Happy"><img
                                                                src="galleys/public/assets/images/icon/03.png"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="HaHa"><img
                                                                src="galleys/public/assets/images/icon/04.png"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="Think"><img
                                                                src="galleys/public/assets/images/icon/05.png"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="Sade"><img
                                                                src="galleys/public/assets/images/icon/06.png"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="#" data-bs-toggle="tooltip"
                                                           data-bs-placement="top" title="Lovely"><img
                                                                src="galleys/public/assets/images/icon/07.png"
                                                                class="img-fluid" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul class="post-comments list-inline p-0 m-0">
                                    <li class="mb-2">
                                        <div class="d-flex">
                                            <div class="user-img">
                                                <img src="galleys/public/assets/images/user/02.jpg" alt="userimg"
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <div class="user-img">
                                                <img src="galleys/public/assets/images/user/03.jpg" alt="userimg"
                                                     class="avatar-35 rounded-circle img-fluid">
                                            </div>
                                            <div class="comment-data-block ms-3">
                                                <h6>Paul Molive</h6>
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                            <div class="user-post-data">
                                <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                        <img class="rounded-circle img-fluid" src="galleys/public/assets/images/user/03.jpg"
                                             alt="">
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex  justify-content-between">
                            ...
                            <div class="user-post">
                                <a href="javascript:void();"><img src="galleys/public/assets/images/page-img/p4.jpg"
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                            <div class="user-post-data">
                                <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                        <img class="rounded-circle img-fluid" src="galleys/public/assets/images/user/04.jpg"
                                             alt="">
                                    </div>
                                    <div class="w-100">
                                        <div class=" d-flex  justify-content-between">
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                        <img class="rounded-circle img-fluid avatar-60"
                                             src="galleys/public/assets/images/user/1.jpg" alt="">
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div class="">
                            ...
                            <div class="user-post text-center">
                                <a href="javascript:void();"><img src="galleys/public/assets/images/page-img/p5.jpg"
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                            <div class="user-post-data">
                                <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                        <img class="rounded-circle img-fluid" src="galleys/public/assets/images/user/02.jpg"
                                             alt="">
                                    </div>
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
            ...
            <!--                                    <img src="galleys/public/assets/images/page-img/s2.jpg" alt="story-img"-->
            ...
            <!--                                </li>-->
            <!--                                <li class="d-flex mb-3 align-items-center">-->
            <!--                                    <img src="galleys/public/assets/images/page-img/s3.jpg" alt="story-img"-->
            <!--                                         class="rounded-circle img-fluid">-->
            <!--                                    <div class="stories-data ms-3">-->
            <!--                                        <h5>Ira Membrit</h5>-->
            ...
            <!--                                    <img src="galleys/public/assets/images/page-img/s1.jpg" alt="story-img"-->
            <!--                                         class="rounded-circle img-fluid">-->
            <!--                                    <div class="stories-data ms-3">-->
            <!--                                        <h5>Bob Frapples</h5>-->
            ...
            <!--                                    <img src="galleys/public/assets/images/page-img/s4.jpg" alt="story-img"-->
            <!--                                         class="rounded-circle img-fluid">-->
            <!--                                    <div class="stories-data ms-3">-->
            <!--                                        <h5>Web Workshop</h5>-->
            <!--                                        <p class="mb-0">1 hour ago</p>-->
            ...
            <!--                                </li>-->
            <!--                                <li class="d-flex align-items-center">-->
            <!--                                    <img src="galleys/public/assets/images/page-img/s5.jpg" alt="story-img"-->
            <!--                                         class="rounded-circle img-fluid">-->
            <!--                                    <div class="stories-data ms-3">-->
            ...
            <!--                            <ul class="media-story list-inline m-0 p-0">-->
            <!--                                <li class="d-flex mb-4 align-items-center">-->
            <!--                                    <img src="galleys/public/assets/images/user/01.jpg" alt="story-img"-->
            <!--                                         class="rounded-circle img-fluid">-->
            <!--                                    <div class="stories-data ms-3">-->
            <!--                                        <h5>Anna Sthesia</h5>-->
            ...
            <!--                                </li>-->
            <!--                                <li class="d-flex align-items-center">-->
            <!--                                    <img src="galleys/public/assets/images/user/02.jpg" alt="story-img"-->
            <!--                                         class="rounded-circle img-fluid">-->
            <!--                                    <div class="stories-data ms-3">-->
            <!--                                        <h5>Paul Molive</h5>-->
            ...
            <!--                                        <img src="galleys/public/assets/images/page-img/42.png" alt="story-img"-->
            ...
            <!--                                        </div>-->
            <!--                                    </div>-->
            <!--                                    <img src="galleys/public/assets/images/small/img-1.jpg" class="img-fluid rounded"-->
            ...
            <!--                                        </div>-->
            <!--                                    </div>-->
            <!--                                    <img src="galleys/public/assets/images/small/img-2.jpg" class="img-fluid rounded"-->
            <!--                                         alt="Responsive image">-->
            <!--                                    <div class="mt-3"><a href="#" class="btn d-block"><i-->
            <!--                                            class="ri-thumb-up-line me-2"></i> Like Page</a></div>-->
            <!--                                </li>-->
